...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'hello_person', (
            ...
            ('jabber', self.gf('django.db.models.fields.CharField')(max_length=55)),
            ('skype', self.gf('django.db.models.fields.CharField')(max_length=55)),
            ('other_contacts', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
    ...
    models = {
        u'hello.person': {
            ...
            'jabber': ('django.db.models.fields.CharField', [], {'max_length': '55'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '55'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '55'}),
            'other_contacts': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'skype': ('django.db.models.fields.CharField', [], {'max_length': '55'})
        }
    }
